...
def main():
    ...
    parser.add_argument("--id",   type=str, required=False, default="session_1",
                    help="Session identifier (e.g. P001, John, session_1) — used only to label output files. Defaults to 'session_1' if not provided.")
